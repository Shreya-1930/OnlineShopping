...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=shreya1930.database.windows.net;Initial Catalog=onlineshopdb;User ID=shreya;Password=india@123");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Feedbacktbl>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__feedback__3213E83FC69FED4F");
        ...
        {
            entity.HasKey(e => e.Pid).HasName("PK__products__DD37D91AB360795C");
        ...
        {
            entity.HasKey(e => e.Uname).HasName("PK__Register__C7D2484F2545DBCD");
        ...
        {
            entity.HasKey(e => e.Tranid).HasName("PK__userorde__9A599E034C8FD258");
